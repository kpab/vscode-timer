...
export class TimeCardGenerator {
    ...
    static async generateTimeCard(context: vscode.ExtensionContext, timeTracker: any) {
    ...
    private static getWebviewContent(timeTracker: any): string {
...
<body>
    ...
    private static generateSVG(dateStr: string, totalHours: number, totalMinutes: number, totalFiles: number, fileData: FileData[]): string {
        const width = 800;
        const height = 600;
